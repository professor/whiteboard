...
describe PresentationsController do
  context "any user can" do
    ...
    describe "POST create_feedback" do
      ...
      before do
        @q1 = FactoryGirl(:presentation_feedback_questions, :text => "q1")
        @q2 = FactoryGirl(:presentation_feedback_questions, :text => "q2")
        @q3 = FactoryGirl(:presentation_feedback_questions, :text => "q3")
        @q4 = FactoryGirl(:presentation_feedback_questions, :text => "q4")
      end
  ...
  context "Student Can NOT" do
     before do
       login(FactoryGirl(:student_sally))
