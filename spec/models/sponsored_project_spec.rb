...
describe SponsoredProject do
  ...
  it 'name must be unique' do
    project = FactoryGirl(:sponsored_project)
  ...
  describe "objects" do
    before(:each) do
      @archived = FactoryGirl(:sponsored_project, :is_archived => true)
      @current = FactoryGirl(:sponsored_project, :is_archived => false)
    end
