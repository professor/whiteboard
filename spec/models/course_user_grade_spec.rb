...
describe CourseUserGrade do
  it "should have a grade that is present in the grading range" do
    ...
    grading_range_grades = course_user_grade.course.grading_ranges.map {|grading_range| grading_range.grade}
  ...
  it "should not have a grade that is not present in the grading range" do
