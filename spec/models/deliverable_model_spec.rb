...
#!(self.feedback_comment.nil? or self.feedback_comment == "") or !self.feedback_file_name.nil?
  ...
  context "for a professor" do
    ...
    it "Displays the professor's students individual deliverables if the professor has at least one team" do
      ...
      @deliverable1 = FactoryGirl.create(:turing_individual_deliverable,:course => @course_fse, :assignment => @assignment1)
      @deliverable2 = FactoryGirl.create(:turing_individual_deliverable,:course => @course_fse, :assignment => @assignment1)
      @deliverable3 = FactoryGirl.create(:individual_deliverable, :course => @course_fse, :assignment => @assignment1)
    ...
    it "Displays individual deliverables for a course that has teams" do
      #@team_turing =  FactoryGirl.create(:team_turing, :course=>@course_fse)
