class AddIsArchivedToSponsoredProjectsEtAl < ActiveRecord::Migration
  def self.up
    add_column :sponsored_project_allocations, :is_archived, :boolean, :default => false
    ...
    add_index :sponsored_project_allocations, :is_archived
  ...
  def self.down
    ...
    remove_index :sponsored_project_allocations, :is_archived

    remove_column :sponsored_projects, :is_archived
    remove_column :sponsored_project_sponsors, :is_archived
    remove_column :sponsored_project_allocations, :is_archived
  end
end
