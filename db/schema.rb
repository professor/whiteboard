...
ActiveRecord::Schema.define(:version => 20121112210500) do
  ...
  add_index "assignment_grades", ["assignment_id"], :name => "index_assignment_grades_on_assignment_id"
  add_index "assignment_grades", ["user_id"], :name => "index_assignment_grades_on_user_id"
