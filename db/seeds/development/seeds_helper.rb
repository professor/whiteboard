    ...
    if assignment.is_team_deliverable
      course.teams.each do |team|
        ...
        team.members.each do |member|
          grade = FactoryGirl.create(:grade_points, :course_id=>course.id, :assignment => assignment, :student_id => member.id)
          grade.score = score
          grade.save
        end
      end
      ...
      course.registered_students.each do |student|
        ...
        grade = FactoryGirl.create(:grade_points, :course_id=>course.id, :assignment => assignment, :student_id => student.id)
