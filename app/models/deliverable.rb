...
class Deliverable < ActiveRecord::Base
  ...
  def self.team_deliverables_for_grading_queue(course_id, append_where_clause = '', *where_clause_params)
    ...
    sql = self.sanitize_sql([sql_query, course_id, *where_clause_params])

    self.connection.execute(sql)
  end

  def self.individual_deliverables_for_grading_queue(course_id, append_where_clause = '', *where_clause_params)
