...
# The design of gradebook is to encapusulate the grading from the submission, therefore we only focus on everything related to scores in this model. 
#
...
# * score should be number greater than zero, and we don't validate whether the score is greater than maximum number defined in Assignment object, so that professor will be able to add extra credit on student's grade. 
